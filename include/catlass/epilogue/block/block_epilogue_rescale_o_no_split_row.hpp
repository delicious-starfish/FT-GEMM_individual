...
public:
    ...
    void SubCoreCompute(
        ...
        uint32_t kvSIdx, uint32_t qNThisSubBlock,
    ...
    void operator()(
        ...
        uint32_t kvSIdx, uint32_t qSBlockSize, uint32_t qNBlockSize,
        uint32_t isFirstStackTile, uint32_t isLastStackTile, uint32_t curStackTileMod)
    {
        ...
        if (inRowActualThisSubBlock > 0) {
            ...
            SubCoreCompute(
                ...
                kvSIdx, qNThisSubBlock, isFirstStackTile, isLastStackTile, curStackTileMod);
        }
    }
