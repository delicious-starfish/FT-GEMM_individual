#ifndef CATLASS_GEMV_BLOCK_BLOCK_SUM_AIV_NOSPLITK_HPP
#define CATLASS_GEMV_BLOCK_BLOCK_SUM_AIV_NOSPLITK_HPP
...
public:
    ...
    static constexpr uint32_t Ybuf_SIZE_ = 24 * 1024;
    static constexpr uint32_t workspace_SIZE_ = 8 * 1024;
        ...
        GemvCoord const &actualShape)
    {
        ...
        for (uint32_t NLoopIdx = 0; NLoopIdx < Nloop; NLoopIdx++) {
            ...
            AscendC::Duplicate<ElementY>(UbYTensor, (ElementY)0.0, m_actual_total);
            ...
            auto UbYTile = UbYTensor[A_row_offset]; 
            ...
            for(uint32_t MLoopIdx = 0; MLoopIdx < Mloop; MLoopIdx++) {
                ...
                */
                tileFaultSum(UbYTile[TileY_col_offset],
