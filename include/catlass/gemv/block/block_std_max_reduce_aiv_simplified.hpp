...
#ifndef CATLASS_GEMV_BLOCK_BLOCK_STD_MEAN_MAX_AIV_HPP_SIMPLIFIED
#define CATLASS_GEMV_BLOCK_BLOCK_STD_MEAN_MAX_AIV_HPP_SIMPLIFIED
...
public:
        ...
        uint32_t simpling_stride)
    {
        ...
        */
        // AscendC::Abs(UbYTensorforBVarList[UbOutListId], UbYTensorforBVarList[UbOutListId], m_actual);
        // AscendC::PipeBarrier<PIPE_V>();
        AscendC::Sqrt(UbYTensorforBVarList[UbOutListId], 
            UbYTensorforBVarList[UbOutListId], m_actual);
        AscendC::PipeBarrier<PIPE_V>();
        AscendC::SetFlag<AscendC::HardEvent::V_MTE3>((event_t)(UbOutEventList[UbOutListId]));
        AscendC::WaitFlag<AscendC::HardEvent::V_MTE3>((event_t)(UbOutEventList[UbOutListId]));
