...
#ifndef CATLASS_GEMV_BLOCK_BLOCK_THRESHOLD_COMPUTE_AIV_HPP
#define CATLASS_GEMV_BLOCK_BLOCK_THRESHOLD_COMPUTE_AIV_HPP
...
public:
    ...
    /// Construct
    CATLASS_DEVICE
    BlockThresholdCalc(Arch::Resource<ArchTag> &resource, uint32_t UBufAddrStart = 0)
    {
    ...
    /// Construct
    CATLASS_DEVICE
    BlockThresholdCalc(Arch::ResourceAIV<ArchTag> &resource, uint32_t UBufAddrStart = 0)
    {
        uint32_t UbAOffset = UBufAddrStart;
        // uint32_t UbXOffset = UBufAddrStart + Abuf_SIZE_;
        // + Xbuf_SIZE_ + Xbuf_SIZE_ 
        ...
        GemvCoord const &actualShape, ElementY alpha)
    {
        ...
        // ELE_NUM_PER_REPEAT,
            // CeilDiv(m_actual * ELE_NUM_PER_C0, ELE_NUM_PER_C0),
            // 1,
            // 8
        ...
        */
        AscendC::Duplicate<ElementY>(UbYTensorList[UbOutListId], (ElementY)0.0, actualShape.m());
        ...
        tileVmuls(UbYTensorList[UbOutListId], UbYTensorList[UbOutListId], (ElementY)alpha, actualShape.m());
