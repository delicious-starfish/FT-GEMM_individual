#ifndef CATLASS_GEMV_BLOCK_BLOCK_AIC_FT_DOUBLE_HPP
#define CATLASS_GEMV_BLOCK_BLOCK_AIC_FT_DOUBLE_HPP
...
public:
    ...
    /// Construct
    CATLASS_DEVICE
    BlockFTGemvDouble(Arch::Resource<ArchTag>& resource, uint32_t l1BufAddrStart = 0)
    {
