...
#ifndef CATLASS_GEMV_BLOCK_BLOCK_GEMV_ASVAR_CE_AIV_NO_SPLIT_HPP_TILING_SIMPLIFIED
#define CATLASS_GEMV_BLOCK_BLOCK_GEMV_ASVAR_CE_AIV_NO_SPLIT_HPP_TILING_SIMPLIFIED
...
public:
    ...
    /// Construct
    CATLASS_DEVICE
    BlockFTGemvCENoSplitK(Arch::Resource<ArchTag> &resource, float n_sqrt_ratio_factor_remain,
        ...
        Catlass::Arch::CrossCoreFlagWithReverse<> & flagAicFinishStore)
    {
        ...
        for(uint32_t mLoopIdx = 0; mLoopIdx < Mloop; mLoopIdx++){
            ...
            */
            ...
            // AscendC::PipeBarrier<PIPE_V>();
            // UbWforThreTensorforRemainList[UbOutListId], 
            tileThreCalc(
        ...
        if(hasRemain){
            ...
            */
            ...
            tileThreCalc(
                UbThreTensorforRemain, UbAMaxTensor, UbWTensorList[UbOutListId],  
                layoutThreInUb, layoutTileThre, 
                (ElementY)N_sqrt_ratio_factor_Remain, 
                (ElementY)B_slice_var_remain, (ElementY)e_max);
