...
#ifndef CATLASS_GEMV_BLOCK_BLOCK_GEMV_ASVAR_CE_AIV_NO_SPLIT_HPP_SPEC_SIMPLIFIED_PRELOAD
#define CATLASS_GEMV_BLOCK_BLOCK_GEMV_ASVAR_CE_AIV_NO_SPLIT_HPP_SPEC_SIMPLIFIED_PRELOAD
...
public:
    ...
    /// Construct
    CATLASS_DEVICE
    BlockFTGemvCENoSplitKPreload(Arch::Resource<ArchTag> &resource, uint32_t UBufAddrStart = 0)
    {
    ...
    /// Construct
    CATLASS_DEVICE
    BlockFTGemvCENoSplitKPreload(Arch::ResourceAIV<ArchTag> &resource, uint32_t UBufAddrStart = 0)
    {
        uint32_t UbCOffset = UBufAddrStart;
        uint32_t UbYOffset = UBufAddrStart + Cbuf_SIZE_;
        uint32_t UbABeOffset = UBufAddrStart + Cbuf_SIZE_ + Ybuf_SIZE_;
