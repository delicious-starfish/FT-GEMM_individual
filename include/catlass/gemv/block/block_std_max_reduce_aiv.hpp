...
#ifndef CATLASS_GEMV_BLOCK_BLOCK_STD_MEAN_MAX_AIV_HPP
#define CATLASS_GEMV_BLOCK_BLOCK_STD_MEAN_MAX_AIV_HPP
...
public:
        ...
        float kn_scale_ratio)
    {
        ...
        for (uint32_t LoopIdx = 0; LoopIdx < Nloop; LoopIdx++) {
            ...
            */
            tileFaultMean(UbYTensorList[UbOutListId],
        ...
        float kn_scale_ratio)
    {
        ...
        for (uint32_t LoopIdx = 0; LoopIdx < Nloop; LoopIdx++) {
            ...
            */
            tileFaultMax(UbYTensorList[UbOutListId],
                UbATensorList[UbInListId],
                UbWTensorList[UbInListId],
                layoutComputeInUb,
                layoutTileCompute);
