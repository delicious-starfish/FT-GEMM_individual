#ifndef CATLASS_GEMV_BLOCK_BLOCK_SUM_AIV_AE_BMAX_MIXED_NOSPLITK_ROBUST_BF_HPP_VERSION_SECOND
#define CATLASS_GEMV_BLOCK_BLOCK_SUM_AIV_AE_BMAX_MIXED_NOSPLITK_ROBUST_BF_HPP_VERSION_SECOND
...
public:
    ...
    using TileFaultSumBRed = Gemv::Tile::TileFaultSum<ArchTag, FT_REDUCE_TYPE::MAX_MIN, BRedType, XType_>;
    using TileFaultSumBSum = Gemv::Tile::TileFaultSum<ArchTag, FT_REDUCE_TYPE::SUM, BRedType, XType_>;
    using TileFaultSumARed = Gemv::Tile::TileFaultSum<ArchTag, FT_REDUCE_TYPE::MAX_MIN, ARedType, YType_>;
