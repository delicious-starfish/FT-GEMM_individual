...
#ifndef CATLASS_GEMV_BLOCK_BLOCK_SLICEKMN_RED_SUM_FUSED_HPP_ROBUST_BF
#define CATLASS_GEMV_BLOCK_BLOCK_SLICEKMN_RED_SUM_FUSED_HPP_ROBUST_BF
...
struct BlockSliceKMNSum <
    Gemm::GemvAtlasA2,
    Gemv::helper::FT_AIV_PIPE_FUSE_TYPE::A_B_ROBUST_BF,
    UBTileShapeforA_,
    UBTileShapeforB_,
    AType_,
    BType_,
...
public:
    ...
    using ElementBRaw = bfloat16_t;

    using BRawType = Gemm::GemmType<ElementBRaw, LayoutB>;

    using TileCopyforBRaw = Gemv::Tile::TileCopyGemvAiv<ArchTag, BRawType, YType, ZType>
    ...
    */
    ...
    using MatrixCopyGmToUbforBRaw = typename TileCopyforBRaw::MatrixCopyGmToUb;
...
protected:
    ...
    MatrixCopyGmToUbforBRaw matrixCopyGmToUbforBRaw;
