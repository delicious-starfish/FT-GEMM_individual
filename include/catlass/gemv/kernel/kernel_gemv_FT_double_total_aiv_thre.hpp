#ifndef CATLASS_GEMV_KERNLE_GEMV_FT_DOUBLE_THRESHOLD_HPP_TOTAL_AIV
#define CATLASS_GEMV_KERNLE_GEMV_FT_DOUBLE_THRESHOLD_HPP_TOTAL_AIV
...
>
class KernelGemvFTDoubleThreTotalAiv {
public:
    ...
    // Methods
    CATLASS_DEVICE
    KernelGemvFTDoubleThreTotalAiv() {
    }
