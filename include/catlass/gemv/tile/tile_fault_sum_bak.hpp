...
#ifndef CATLASS_GEMV_TILE_TILE_FAULT_SUM_HPP
#define CATLASS_GEMV_TILE_TILE_FAULT_SUM_HPP
                ...
                void>
{
    ...
    )
    {
        ...
        uint64_t add_mask = m_actual * repeat_size;
        AscendC::BinaryRepeatParams params;
        params.dstBlkStride = 1;
        params.src0BlkStride = 1;
        params.src1BlkStride = 1;
        ...
        if (remain > 0)
        {
            ...
            uint64_t remain_mask = m_actual * remain;
            AscendC::Add<ElementA, true>(
                srcTensor_m,
                srcTensor_m[offset],
                srcTensor_m,
...
#endif // CATLASS_GEMV_TILE_TILE_FAULT_SUM_HPP
