...
void Run(Options options) {
    ...
    */
    ...
    using MatmulFTKernel = CubeSelf::Gemm::Kernel::MatmulAsVarABonAicNoSplitSpecRobust<
    ...
    */
    ...
    typename MatmulFTKernel::Arguments arguments{
        ...
        options.round_exp, options.beta, options.e_max, 
        options.reduce_cores, rce_thre_type,
        true,true, options.split_ks};
