...
#ifndef CATLASS_GEMM_BLOCK_BLOCK_MMAD_PINGPONG_HPP_SELF
#define CATLASS_GEMM_BLOCK_BLOCK_MMAD_PINGPONG_HPP_SELF
...
public:
    ...
    */
    /// Construct
    CATLASS_DEVICE
    BlockMmad(Catlass::Arch::Resource<ArchTag> &resource, uint32_t l1BufAddrStart = 0)
    {   
