...
#ifndef CATLASS_GEMM_BLOCK_BLOCK_MMAD_PINGPONG_HPP_FT_ABE_NO_SPLITK_SELF
#define CATLASS_GEMM_BLOCK_BLOCK_MMAD_PINGPONG_HPP_FT_ABE_NO_SPLITK_SELF
...
public:
    ...
    static_assert((L0A_SIZE_FOR_A + L0A_SIZE_FOR_X) <= L0A_SIZE, "space for A and X exceeding the L0A space!");
