...
#ifndef CATLASS_GEMM_BLOCK_BLOCK_MMAD_PINGPONG_HPP_FT_ABE_NO_SPLITK_BAK
#define CATLASS_GEMM_BLOCK_BLOCK_MMAD_PINGPONG_HPP_FT_ABE_NO_SPLITK_BAK
            ...
            for(int mPartIdx=0; mPartIdx < mPartLoop; mPartIdx++){
                ...
                for(int kPartIdx=0; kPartIdx < kPartLoop; kPartIdx++){
                    ...
                    for(int nPartIdx = 0; nPartIdx < nPartLoop; nPartIdx++){
                        ...
                        AscendC::SetFlag<AscendC::HardEvent::M_MTE1>(l0XEventList[l0BListId]);
