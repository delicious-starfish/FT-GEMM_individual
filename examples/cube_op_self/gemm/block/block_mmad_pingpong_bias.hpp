...
#ifndef CATLASS_GEMM_BLOCK_BLOCK_MMAD_PINGPONG_BIAS_HPP_SELF
#define CATLASS_GEMM_BLOCK_BLOCK_MMAD_PINGPONG_BIAS_HPP_SELF
// catlass/ catlass/ catlass/
...
>
struct BlockMmad<
    CubeSelf::Gemm::MmadAtlasA2PingpongBias<ENABLE_UNIT_FLAG_>,
    L1TileShape_,
    L0TileShape_,
    AType_,
    BType_,
...
public:
    // Type Aliases
    using DispatchPolicy = CubeSelf::Gemm::MmadAtlasA2PingpongBias<ENABLE_UNIT_FLAG_>;
    ...
    using CopyL1ToL0B = typename TileCopy_::CopyGmToL1B;
    ...
    static constexpr uint32_t L0B_TILE_SIZE = L0TileShape::N * L0TileShape::K * sizeof(ElementB);
        ...
        Catlass::GemmCoord const &actualShape)
    {
        ...
        auto layoutBiasInL1 = Catlass::layout::VectorLayout(L1TileShape::N);

        auto layoutBiasInL0 = Catlass::layout::VectorLayout(L0TileShape::N);
        ...
        auto layoutTileBias = Catlass::layout::VectorLayout(actualShape.n());
            ...
            for(int mPartIdx=0; mPartIdx < mPartLoop; mPartIdx++){
                ...
                for (int kPartIdx = 0; kPartIdx < kPartLoop; kPartIdx++){
                    ...
                    for(int nPartIdx = 0; nPartIdx < nPartLoop; nPartIdx++) {
                        ...
                        Catlass::MatrixCoord l1BOffset{kPartIdx * L0TileShape::K, nPartIdx * L0TileShape::N};
