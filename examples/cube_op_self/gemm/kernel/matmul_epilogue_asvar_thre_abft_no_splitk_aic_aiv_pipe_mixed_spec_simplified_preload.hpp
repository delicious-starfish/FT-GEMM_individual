#ifndef CATLASS_GEMM_KERNEL_MATMUL_BE_ABE_ON_AIC_ASVAR_THRESHOLD_ABFT_NO_SPLITK_HPP_SPEC_SIMPLIFIED_PRELOAD
#define CATLASS_GEMM_KERNEL_MATMUL_BE_ABE_ON_AIC_ASVAR_THRESHOLD_ABFT_NO_SPLITK_HPP_SPEC_SIMPLIFIED_PRELOAD
...
>
class MatmulAsVarABonAicNoSplitSpecSimplifiedPreload {
public:
    ...
    struct Params {
        ...
        float simple_std_est_A_row_ratio;
        uint32_t SplitNnum;
        ...
        Params(
            ...
            float simple_std_est_A_row_ratio_,
            uint32_t SplitNnum_, 
            ...
            std_est_A_row_ratio(std_est_A_row_ratio_),
            A_row_scale_ratio(A_row_scale_ratio_),
    ...
    static Params ToUnderlyingArguments(const Arguments &args, uint8_t *workspace)
    {
        ...
        if(args.useLogRatio < 1){
            ...
            simple_std_est_A_row_factor = std::sqrt(2.0f * logf((k2 * 1.0f)));
        }
        ...
        if(n_remain_split > 0){
            ...
            if(args.useLogRatio < 1){
                ...
                simple_remain_std_factor = std::sqrt(2.0f * logf(n_remain_split));
            }
        ...
        */
        ...
        Params params{
            ...
            n_ratios, n_sqrt_ratios, n_square_ratios, simple_std_est_ratios,
            simple_std_est_A_row_ratio,
    ...
    // Methods
    CATLASS_DEVICE
    MatmulAsVarABonAicNoSplitSpecSimplifiedPreload() {}
    ...
    void BE_split_op_on_AIC_BF(Params const &params)
    {
        ...
        AscendC::GlobalTensor<ElementYforB> gmYforAIV;
        gmYforAIV.SetGlobalBuffer((__gm__ ElementYforB *)params.ptrBEforAIV);
