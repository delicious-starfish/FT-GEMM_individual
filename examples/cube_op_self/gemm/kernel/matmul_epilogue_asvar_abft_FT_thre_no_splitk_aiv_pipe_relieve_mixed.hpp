#ifndef CATLASS_GEMM_KERNEL_MATMUL_DOUBLE_FT_THRESHOLD_NO_SPLITK_HPP_ASVAR_ABFT_RELIEVE_MIXED
#define CATLASS_GEMM_KERNEL_MATMUL_DOUBLE_FT_THRESHOLD_NO_SPLITK_HPP_ASVAR_ABFT_RELIEVE_MIXED
...
>
class MatmulAsVarFTThreNoSplitRelieveMixed {
public:
    ...
    using ElementY = typename BlockFTGemv::ElementX;
    using LayoutY = typename BlockFTGemv::LayoutX;
    ...
    using ElementZ = typename BlockFTGemv::ElementY;
    ...
    // Methods
    CATLASS_DEVICE
    MatmulAsVarFTThreNoSplitRelieveMixed() {}
        ...
        */
        ...
        for (uint32_t loopIdx = aicoreIndex; loopIdx < coreLoops; loopIdx += aicoreNum) {
            ...
            */
            ...
            //  params.outputThre, params.outputABE, 

            // blockFTGemv.gemv_fused_thre_op(
            //     gmA[gmOffsetA], params.layoutA,
            //     gmY[gmOffsetX], layoutX,
            //     gmCOMPX[gmOffsetYforFT], layoutABE,
            //     gmBMean[splitNIdx],
            //     gmBMax[splitNIdx], layoutBforFT,
            ...
            //     k_sqrt_n_ratio_factor, params.e_max, aiv_part_num);
