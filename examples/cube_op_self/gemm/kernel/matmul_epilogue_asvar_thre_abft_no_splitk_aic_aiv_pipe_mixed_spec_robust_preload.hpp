#ifndef CATLASS_GEMM_KERNEL_MATMUL_BE_ABE_ON_AIC_ASVAR_THRESHOLD_ABFT_NO_SPLITK_HPP_SPEC_ROBUST_PRELOAD
#define CATLASS_GEMM_KERNEL_MATMUL_BE_ABE_ON_AIC_ASVAR_THRESHOLD_ABFT_NO_SPLITK_HPP_SPEC_ROBUST_PRELOAD
...
>
class MatmulAsVarABonAicNoSplitSpecRobustPreload {
public:
    ...
    // Methods
    CATLASS_DEVICE
    MatmulAsVarABonAicNoSplitSpecRobustPreload() {}
