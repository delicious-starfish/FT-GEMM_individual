#ifndef CATLASS_GEMM_KERNEL_MATMUL_EPILOGUE_HPP_SELF
#define CATLASS_GEMM_KERNEL_MATMUL_EPILOGUE_HPP_SELF
...
public:
    ...
    struct Params {
        ...
        Params(
            ...
            GM_ADDR ptrWorkspace_, EpilogueParams const &epilogueParams_, GM_ADDR ptrC_
        ) : problemShape(problemShape_), ptrA(ptrA_), layoutA(layoutA_), ptrB(ptrB_), layoutB(layoutB_), 
            ptrWorkspace(ptrWorkspace_), epilogueParams(epilogueParams_), ptrC(ptrC_) {} 
    };
    ...
    static Params ToUnderlyingArguments(const Arguments &args, uint8_t *workspace)
    {
        ...
        Params params{problemShape, args.ptrA, layoutA, args.ptrB, layoutB, workspace, epilogueParams, args.ptrC};
