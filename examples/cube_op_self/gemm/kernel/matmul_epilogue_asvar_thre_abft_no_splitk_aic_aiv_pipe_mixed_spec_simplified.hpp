#ifndef CATLASS_GEMM_KERNEL_MATMUL_BE_ABE_ON_AIC_ASVAR_THRESHOLD_ABFT_NO_SPLITK_HPP_SPEC_SIMPLIFIED
#define CATLASS_GEMM_KERNEL_MATMUL_BE_ABE_ON_AIC_ASVAR_THRESHOLD_ABFT_NO_SPLITK_HPP_SPEC_SIMPLIFIED
...
public:
    ...
    // Methods
    CATLASS_DEVICE
    MatmulAsVarABonAicNoSplitSpecSimplified() {}
    ...
    void CE_split_op_fused(Params const &params, GM_ADDR ptrOutputCOMP)
    {
        ...
        for (uint32_t loopIdx = aicoreIndex; loopIdx < coreLoops; loopIdx += aicoreNum) {
            ...
            void operator()(
                ...
                float e_max,
                bool outputThre, bool outputCE, uint32_t aiv_part_num,
                Catlass::Arch::CrossCoreFlagWithReverse<> & flagAicFinishStore)
            */
            // bool outputStd = false;
            // if(splitNIdx == 0){
            //     outputStd = true;
            // }
            // gmStdA[gmOffsetARed],
            ...
            blockFTGemvAIV(
                ...
                actualBlockShape, params.simple_std_est_A_row_ratio, 
                std_est_B_ratio,
                n_sqrt_ratio_factor, 
                params.e_max, 
                params.outputThre, 
