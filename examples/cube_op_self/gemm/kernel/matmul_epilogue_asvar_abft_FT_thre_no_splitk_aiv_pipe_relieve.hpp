#ifndef CATLASS_GEMM_KERNEL_MATMUL_DOUBLE_FT_THRESHOLD_NO_SPLITK_HPP_ASVAR_ABFT_RELIEVE
#define CATLASS_GEMM_KERNEL_MATMUL_DOUBLE_FT_THRESHOLD_NO_SPLITK_HPP_ASVAR_ABFT_RELIEVE
...
>
class MatmulAsVarFTThreNoSplitRelieve {
public:
    ...
    // Methods
    CATLASS_DEVICE
    MatmulAsVarFTThreNoSplitRelieve() {}
