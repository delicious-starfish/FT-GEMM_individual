#ifndef CATLASS_GEMM_KERNEL_MATMUL_BE_ABE_ON_AIC_ASVAR_THRESHOLD_ABFT_NO_SPLITK_HPP_SPLIT_ROBUST
#define CATLASS_GEMM_KERNEL_MATMUL_BE_ABE_ON_AIC_ASVAR_THRESHOLD_ABFT_NO_SPLITK_HPP_SPLIT_ROBUST
...
>
class MatmulAsVarABonAicNoSplitSplitRobust {
public:
    ...
    // Methods
    CATLASS_DEVICE
    MatmulAsVarABonAicNoSplitSplitRobust() {}
    ...
    void CE_split_op_fused(Params const &params, GM_ADDR ptrOutputCOMP)
    {
        ...
        for (uint32_t loopIdx = aicoreIndex; loopIdx < coreLoops; loopIdx += aicoreNum) {
            ...
            AscendC::GlobalTensor<ElementY> const &gmAMax, AscendC::GlobalTensor<ElementY> const &gmAMean, 
            AscendC::GlobalTensor<ElementY> const &gmAMin, LayoutX const &layoutAforFT,
            AscendC::GlobalTensor<ElementY> const &gmY, AscendC::GlobalTensor<ElementY> const &gmABe, 
            LayoutY const &layoutY, AscendC::GlobalTensor<ElementY> const &gmBMeanAbs,
            ...
            GemvCoord const &actualShape, float n_ratio_factor, float n_sqrt_ratio_factor, 
            float n_square_ratio_factor, float e_max, bool outputThre, bool outputCE,
            ...
            */
            blockFTGemvAIV(
                ...
                actualBlockShape, n_ratio_factor, n_sqrt_ratio_factor,
