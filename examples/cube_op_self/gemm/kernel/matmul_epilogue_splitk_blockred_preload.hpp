...
#ifndef CATLASS_GEMM_KERNEL_SPLITK_MATMUL_HPP_PRELOAD_BLK_REDUCE
#define CATLASS_GEMM_KERNEL_SPLITK_MATMUL_HPP_PRELOAD_BLK_REDUCE
...
>
class MatmulAsVarSplitKBlkRedPreload {
public:
    ...
    //     CATLASS_HOST_DEVICE
    //     Params(Catlass::GemmCoord const &problemShape_, GM_ADDR ptrA_, LayoutA layoutA_, GM_ADDR ptrB_,
    ...
    // Methods
    CATLASS_DEVICE
    MatmulAsVarSplitKBlkRedPreload() {}
...
private:
    // static constexpr Catlass::Arch::FlagID FLAG_AIC_FINISH = 0;
    // Catlass::Arch::CrossCoreFlag flagAicFinish{FLAG_AIC_FINISH};
