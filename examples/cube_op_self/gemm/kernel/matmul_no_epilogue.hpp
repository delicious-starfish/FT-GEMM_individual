#ifndef CATLASS_GEMM_KERNEL_MATMUL_NO_EPILOGUE_HPP_SELF
#define CATLASS_GEMM_KERNEL_MATMUL_NO_EPILOGUE_HPP_SELF
...
public:
    ...
    static Params ToUnderlyingArguments(const Arguments &args, uint8_t *workspace)
    {
        ...
        Params params{problemShape, args.ptrA, layoutA, args.ptrB, layoutB, workspace, args.ptrC};
