#ifndef CATLASS_GEMM_KERNEL_MATMUL_DOUBLE_FT_THRESHOLD_COMP_FUSED_HPP_SELF
#define CATLASS_GEMM_KERNEL_MATMUL_DOUBLE_FT_THRESHOLD_COMP_FUSED_HPP_SELF
...
>
class MatmulFTDoubleBaseThreFused {
public:
    ...
    struct Params {
        ...
        Params(
            ...
            GM_ADDR ptrThreZ_, LayoutCOMPX layoutThre_, 
            ElementZ rounding_alpha_, bool outputThre_
            ...
            rounding_alpha(rounding_alpha_), outputThre(outputThre_){} 
    ...
    static Params ToUnderlyingArguments(const Arguments &args, uint8_t *workspace)
    {
        ...
        Params params{
            ...
            args.ptrThreZ, layoutThre, rounding_alpha, args.outputThre};
    ...
    void operator()<AscendC::AIV>(Params const &params){
        ...
        if(params.enc_type == FT_ENC_TYPE::CE){
            ...
            /*
            void Threshold_Compare_fused_op(Params const &params,
                GM_ADDR ptrInputX, GM_ADDR ptrInputY, GM_ADDR ptrOutputCOMP)
            */
