...
#include "gemm/kernel/matmul_epilogue_asvar_thre_abft_no_splitk_aic_aiv_pipe_mixed_split_robust_preload.hpp"
...
void Run(Options options) {
    ...
    */
    ...
    using MatmulFTKernel = CubeSelf::Gemm::Kernel::MatmulAsVarABonAicSplitRobustPreload<
    ...
    */
    ...
    errorIndices = golden::CompareData(hostThre, hostThre, lenThre);
    if (errorIndices.empty()) {
